...
namespace g_Offsets
{
	...
	namespace signatures
	{
		...
		inline uintptr_t ClientState;
		inline uintptr_t dwViewMatrix;
		inline uintptr_t ClientState_ViewAngles;
		inline uintptr_t ClientState_MaxPlayer;
		inline uintptr_t dwClientState_Map;
